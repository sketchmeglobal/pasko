        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">
                  <a href="<?=base_url('invoice/invoice-add-export')?>" class="badge badge-gradient-success"> <i class="mdi mdi-plus"></i> Create</a>
                </h4>
                <hr>
                <div class="row">
                  <div class="col-12">
                      ...
                      <tbody>
                        ...
                        if(count($invoice_headers) > 0) {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?=base_url('invoice/invoice-edit-export/') . $ih->id?>" class="badge badge-gradient-primary"> <i class="mdi mdi-file-edit"></i>&nbsp;Edit</a>
                              <!--<a href="<?=base_url('invoice/invoice-payments-export/') . $ih->id?>" class="badge badge-gradient-info"> <i class="mdi mdi-cash-clock"></i>&nbsp;Payment</a>-->
                              <a href="<?=base_url('invoice/invoice-json-format-export/') . $ih->id?>" class="badge badge-gradient-warning"> <i class="mdi mdi-cash-clock"></i>&nbsp;JSON</a>
                              ...
                              <a href="<?= base_url('invoice/invoice-print-export/') . $ih->id ?>" target="_blank"
